import logo from "./../../public/yask.svg";
...
export default function MainLogo({
  ...
  return (
    <Image
      className={`dark:invert dark:saturate-0 ${className}`}
      src={logo}
      width={width}
      height={height}
      alt="Yask"
    ...
    //   height={height}
    //   viewBox={`0 0 72 72`}
    //   className={`fill-primary inline-block text-center dark:fill-ytextdark ${className}`}
