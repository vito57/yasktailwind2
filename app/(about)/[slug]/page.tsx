  ...
  return (
    <div className="container">
      ...
      <header className="text-center relative rounded-xl mb-4">
        ...
        <blockquote className="absolute top-0  right-0 italic text-left max-w-xs">
      ...
      <div className="flex gap-2  items-center justify-center sticky z-50 top-3 mb-16">
        {user.resume ? (
      ...
      <Text title="About">
        <p className="text-xl">{user.about}</p>
      </Text>
      ...
      <Text title="Education">
        <p className="text-xl">{user.education}</p>
      </Text>
      <Text title="Courses">
        <ul>
          <li>
